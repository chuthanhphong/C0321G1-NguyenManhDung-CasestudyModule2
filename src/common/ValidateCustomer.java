...
public class ValidateCustomer {
    ...
    public boolean validateDateOfBirth(String str) throws InterruptedException {
        ...
        if (yearNow - yearDOB < 18 || yearDOB < 1900) {
            System.err.println("---Năm sinh phải >1900 và nhỏ hơn năm hiện tại 18 năm---");
            Thread.sleep(250);
            return false;
        }
    ...
    public boolean validateTypeOfCustomer(String str){
        ...
        return str.equals("Diamond") || str.equals("Platinium") || str.equals("Gold") || str.equals("Silver") || str.equals("Member");
    }
